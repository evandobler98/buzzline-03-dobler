...
def get_kafka_topic() -> str:
    ...
    topic = os.getenv("BUZZ_TOPIC", "dobler_topic")  # Unique topic name
...
def get_message_interval() -> int:
    ...
    interval = int(os.getenv("BUZZ_INTERVAL_SECONDS", 2))  # Increased interval for example
...
# Data folder for example custom data
DATA_FOLDER: pathlib.Path = PROJECT_ROOT.joinpath("data")
logger.info(f"Data folder: {DATA_FOLDER}")

# Custom data file for this example
DATA_FILE: pathlib.Path = DATA_FOLDER.joinpath("dobler_data.json")
